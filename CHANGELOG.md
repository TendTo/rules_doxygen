...
- Default doxygen version is now `1.18.0`
- Added Bazel 9.x, ubuntu2404, and debian13 to the CI matrix

## [2.6.3]

### Changed

- Default doxygen version is now `1.17.0`
- Updated dependencies (platforms 1.0.0 -> 1.1.0)
