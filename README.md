...
[![Bazel Central Repository](https://img.shields.io/badge/BCR-2.3.0-%230C713A?logo=bazel)](https://registry.bazel.build/modules/rules_doxygen)
...
bazel_dep(name = "rules_doxygen", version = "2.3.0", dev_dependency = True)
```
